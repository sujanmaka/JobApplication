...
import edu.miu.cs544.sujan.jobboot.entity.*;
import edu.miu.cs544.sujan.jobboot.enums.Location;
import edu.miu.cs544.sujan.jobboot.repository.ApplicationRepository;
import edu.miu.cs544.sujan.jobboot.repository.CompanyRepository;
import edu.miu.cs544.sujan.jobboot.repository.InterviewRepository;
...
//        jobs.add(new Job("Project Manager", 20000));
//        jobs.add(new Job("Backend Developer", 20001));
//        jobs.add(new Job("System Engineer", 20000));
//        jobs.add(new Job("Frontend Developer", 30000));
//        jobs.add(new Job("Quality Assurance Engineer", 40000));
